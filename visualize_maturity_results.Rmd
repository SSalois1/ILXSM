...
p <-ggplot(df, aes(x = mat_stage_f, fill = as.factor(vessel_name))) + 
   geom_histogram(position = "identity", alpha = 0.4, color="black") + 
   xlab('Female Maturity Stage (m)') +
   labs(fill = 'Vessel') +
   theme_bw()
p
...
Length as a function of weight for males and females seperately. Here, I indicates the sex was indeterminate for that sample.  
